...
class CadastrosTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $string='Informações / Solicitações / Atendimento / reclamações /  Orçamentos / Cadastramento / Vistoria / Agendar visita / Aviso / Opinião / Assunto Urgente / Assunto  Particular';

      $itens=explode(' / ',$string);

      foreach ($itens as $key => $item) {
          \App\Models\Manifestacao::create(['descricao'=>$item]);
      }
      ...
      $string='Incorporadora / Imobiliária / Diretoria / Setor Administrativo / Setor de Engenharia / Setor de Compras / Setor Comercial / Recursos Humanos / Setor Financeiro / Setor Atendimento a clientes / Corretores / Recepção';

      $itens=explode(' / ',$string);

      foreach ($itens as $key => $item) {
          \App\Models\Manifestacao\Grupo::create(['descricao'=>$item]);
      }
      ...
      $string='Cliente / Novo Lead / Inquilino / Fornecedor / Funcionario / Corretor / Incorporador / Construtor / Amigos / Indicação / Advogado / Cobrança / Fiscalização / Assunto Particular/ Recursos Humanos';

      $itens=explode(' / ',$string);

      foreach ($itens as $key => $item) {
          \App\Models\Manifestacao\Grupo\Tipo::create(['descricao'=>$item]);
      }

                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div style="margin-top: 30px; float: left; width: 50%">
                                            ...
                                            <button type="button" class="btn btn-primary selectImageImovel">Selecione o imóvel</button>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div style="margin-top: 30px; float: left; width: 50%">
                                ...
                                <div role="tabpanel" class="tab-pane" id="infoimovel">
                                  <div class="row">
                                    <div class="col-md-12" style="text-align: center;">
                                        <button type="button" class="btn btn-primary selectImovelInfo">Selecione o imóvel</button>
                                    </div>
                                    <div class="col-md-12">
                                        <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                                            <input readonly="true" style="float: left; margin-top: 4px;" class="form-control" value="" placeholder="0 dorms" type="text" id="dorms">
                                            <input readonly="true" style="float: left; margin-top: 4px;" class="form-control" value="" placeholder="0 suítes" type="text" id="suites">
                                            <input readonly="true" style="float: left; margin-top: 4px;" class="form-control" value="" placeholder="0 vagas" type="text" id="vagas">
                                            <input readonly="true" style="float: left; margin-top: 4px;" class="form-control" value="" placeholder="0 metragem" type="text" id="metragem">
                                        </div>
                                        <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                                            <input style="float: left; margin-top: 4px;" class="form-control" placeholder="Linha editável 1" value="" type="text" id="editavel1">
                                            <input style="float: left; margin-top: 4px;" class="form-control" placeholder="Linha editável 2" value="" type="text" id="editavel2">
                                            <input style="float: left; margin-top: 4px;" class="form-control" placeholder="Linha editável 3" value="" type="text" id="editavel3">
                                            <input style="float: left; margin-top: 4px;" class="form-control" placeholder="Linha editável 4" value="" type="text" id="editavel4">
                                        </div>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                        <div style="float: left; width: 50%; text-align: center; padding: 10px">
                                            <button type="button" class="btn btn-primary btn-img1">Selecione a imagem 1</button>
                                        ...
                                        <div style="float: left; width: 50%; text-align: center; padding: 10px">
                                            <button type="button" class="btn btn-primary btn-img2">Selecione a imagem 2</button>
                                            <div style="float: left; width: 100%; text-align: center; padding: 10px">
                                    ...
                                    <div class="col-md-12">
                                        <div style="float: left; width: 50%; text-align: center; padding: 10px">
                                            <button type="button" class="btn btn-primary btn-img3">Selecione a imagem 3</button>
                                            <div style="float: left; width: 100%; text-align: center; padding: 10px">
                                                <img src="{img3}" id='img3' style="display: none; padding: 10px; width: 100px; height: 100px;">
                                            </div>
                                        </div>
                                        <div style="float: left; width: 50%; text-align: center; padding: 10px">
                                            <button type="button" class="btn btn-primary btn-img4">Selecione a imagem 4</button>
                                            <div style="float: left; width: 100%; text-align: center; padding: 10px">
                                ...
                                <div role="tabpanel" class="tab-pane" id="informacoesgerais">
                                    <div class="row">
                                        <div style="float: left; width: 50%; text-align: center; padding: 10px">
                                            <button type="button" class="btn btn-primary btn-localidade">Obter Localidade/Vídeo</button>
                                            <div style="float: left; width: 100%; text-align: center; padding: 10px">
                                ...
                                <div role="tabpanel" class="tab-pane" id="teste">
                                    <div class="row">
                                        <div style="float: left; width: 100%; text-align: center; padding: 10px">
                                            ...
                                            <button type="button" class="btn btn-primary preview" data-id="1">Preview</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

    ...
    <div class="col-md-12">
      <div class="box box-solid">
          <div class="box-header with-border">
              <h3 class="box-title">Modelo 3</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="card">
                      <ul class="nav nav-tabs" role="tablist">
                          ...
                          <li role="presentation"><a href="#imovel5" aria-controls="imovel5" role="tab" data-toggle="tab">Imóvel 5</a></li>
                          <li role="presentation"><a href="#imovel6" aria-controls="imovel6" role="tab" data-toggle="tab">Imóvel 6</a></li>
                      ...
                      <div class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane" id="imovel2">
                              ...
                              <div class="row">
                                  ...
                                  <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                                      ...
                                      <img src="{d11}" class="imgimovel2" style="display: none;" width="160px" height="160px">
                                  </div>
                              </div>
                          </div>
                          <div role="tabpanel" class="tab-pane" id="imovel3">
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px;">
                                      <button class="btn btn-primary selectImovel3" data-id="3">Selecione o imóvel em obra</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                          ...
                          <div role="tabpanel" class="tab-pane" id="imovel4">
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px;">
                                      <button class="btn btn-primary selectImovel4" data-id="4">Selecione o imóvel em lan&ccedil;amento</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                          ...
                          <div role="tabpanel" class="tab-pane" id="imovel5">
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px;">
                                      <button class="btn btn-primary selectImovel5" data-id="5">Selecione o imóvel em lan&ccedil;amento</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">
                          ...
                          <div role="tabpanel" class="tab-pane" id="imovel6">
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px;">
                                      <button class="btn btn-primary selectImovel6" data-id="6">Selecione o imóvel pronto</button>
                                  </div>
                              </div>
                              <div class="row">
                                  <div style="float: left; width: 50%; padding: 10px; margin-top: 10px">

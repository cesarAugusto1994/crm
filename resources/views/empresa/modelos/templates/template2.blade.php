    ...
    <body yahoo bgcolor="#FFFFFF">
		...
		<div class="container-all">
			<div class="align-div">
				...
				<button class="salvar-mod2 release-label prerelease">SALVAR TEMPLATE</button>
			</div>
		</div>
		<table width="100%" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0">
			<table id="top0" width="902" height="200" align="center" bgcolor="#FFFFFF" background="{{ asset('images/top-emails.png') }}" style='border-left: 1px solid #0138b9; border-right: 1px solid #0138b9' cellpadding="0" cellspacing="0">
				<tr>
					<td>
			...
			<table id="top1" width="902px" align="center" bgcolor="#FFFFFF" style='border-left: 1px solid #0138b9; border-right: 1px solid #0138b9' cellpadding="0" cellspacing="0">
				<tr>
					<td>
			...
			<table id="top2" width="902px" align="center" bgcolor="#FFFFFF" style='border-left: 1px solid #0138b9; border-right: 1px solid #0138b9' cellpadding="0" cellspacing="0">
				{!!$video!!}
			</table>
			<table id="top3" width="900px" align="center" bgcolor="#FFFFFF" style='border-left: 1px solid #0138b9; border-right: 1px solid #0138b9' cellpadding="0" cellspacing="0">
							...
							<tr>
								<td>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td>
												<img style="display:block" src="{{ route('external_images', ['link'=> $img1]) }}" width="450px" height="750px" />
											</td>
										</tr>
									</table>
								</td>
								<td>
									<table cellpadding="0" cellspacing="0" border="0">
										<tr>
											<td>
												<img style="display:block" src="{{ route('external_images', ['link'=> $img2]) }}" width="450px" height="250px" />
											</td>
										</tr>
										<tr>
											<td>
												<img style="display:block" src="{{ route('external_images', ['link'=> $img3]) }}" width="450px" height="250px" />
											</td>
										</tr>
										<tr>
											<td>
												<img style="display:block" src="{{ route('external_images', ['link'=> $img4]) }}" width="450px" height="250px" />
											</td>
										</tr>
									</table>
								</td>
						...
						<table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<td class="font center">
									<img style="display:block" src="{{$mapa}}" width="900" height="450">
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>
						<img style="display:block" src="{{ asset('images/rodape-emails.png') }}" width="900px" height="200px" />
					</td>
				</tr>
			</table>
		</table>
